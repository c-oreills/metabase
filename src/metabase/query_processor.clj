(ns metabase.query-processor
  ...
  (:require [medley.core :as m]
            ...
            [metabase.query-processor.middleware
             [add-calculated-hash :as add-calculated-hash]
...
(defn- qp-pipeline
  ...
  (-> f
      ...
      add-calculated-hash/add-calculated-hash
...
(s/defn process-query-and-save-execution!
  ...
  etc.). Returns results in a format appropriate for consumption by FE client. Saves `QueryExce"
  {:style/indent 1}
